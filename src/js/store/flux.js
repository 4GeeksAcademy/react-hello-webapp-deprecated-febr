const getState = ({ getStore, getActions, setStore }) => {
  ...
  return {
    ...
    actions: {
      createUser: () => {
        fetch(
          "https://playground.4geeks.com/contact/agendas/roberto_contacts",
          {
            method: "POST",
          }
        )
      ...
      getInfoContacts: () => {
        fetch(
          "https://playground.4geeks.com/contact/agendas/roberto_contacts/contacts",
      ...
      deleteContact: (id) => {
        fetch(
          `https://playground.4geeks.com/contact/agendas/roberto_contacts/contacts/${id}`,
          {
            method: "DELETE",
          }
        )
